...
MOCKABLE_FUNCTION(, int, twin_messenger_report_state_async, TWIN_MESSENGER_HANDLE, twin_messenger_handle, IOTHUB_MESSAGE_LIST*, message, ON_MESSENGER_EVENT_SEND_COMPLETE, on_messenger_event_send_complete_callback, void*, context);
MOCKABLE_FUNCTION(, int, twin_messenger_subscribe_for_property_updates, TWIN_MESSENGER_HANDLE, twin_messenger_handle, ON_PROPERTY_UPDATE_RECEIVED, on_property_update_received_callback, void*, context);
MOCKABLE_FUNCTION(, int, twin_messenger_unsubscribe_for_property_updates, TWIN_MESSENGER_HANDLE, twin_messenger_handle);
MOCKABLE_FUNCTION(, int, twin_messenger_start, TWIN_MESSENGER_HANDLE, twin_messenger_handle, SESSION_HANDLE, session_handle);
MOCKABLE_FUNCTION(, int, twin_messenger_stop, TWIN_MESSENGER_HANDLE, twin_messenger_handle);
MOCKABLE_FUNCTION(, void, twin_messenger_do_work, TWIN_MESSENGER_HANDLE, twin_messenger_handle);
MOCKABLE_FUNCTION(, void, twin_messenger_destroy, TWIN_MESSENGER_HANDLE, twin_messenger_handle);
MOCKABLE_FUNCTION(, int, twin_messenger_set_option, TWIN_MESSENGER_HANDLE, twin_messenger_handle, const char*, name, void*, value);
MOCKABLE_FUNCTION(, OPTIONHANDLER_HANDLE, twin_messenger_retrieve_options, TWIN_MESSENGER_HANDLE, twin_messenger_handle);
