...
**SRS_IOTHUBTRANSPORT_AMQP_TWIN_MESSENGER_09_123: [**`instance->on_twin_state_update_callback` shall be invoked passing the IOTHUB_MESSAGE_HANDLE and MESSENGER_MESSAGE_DISPOSITION_INFO instance**]**  
